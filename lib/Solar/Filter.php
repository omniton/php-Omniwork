...
class Solar_Filter extends Solar_Base
{
    ...
    public function setAllChainRequire($list)
    {
        foreach ((array) $list as $key) $this->setChainRequire($key);
    }
    ...
    public function setAllChainFilters($list)
    {
        foreach ((array) $list as $key => $spec) {
            $this->addChainFilters($key, $spec);
        }
    }
